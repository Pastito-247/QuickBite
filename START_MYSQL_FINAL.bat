...
start "Menu Service" cmd /k "cd Backend\quickbite-menu-service\menu-service && mvn spring-boot:run"
...
start "Payment Service" cmd /k "cd Backend\quickbite-payment-service\payment-service && mvn spring-boot:run"
